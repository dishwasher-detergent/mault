...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      {...props}
    >
      <SelectPrimitive.ItemText className="flex flex-1 gap-2 overflow-hidden pr-4">
        {children}
      </SelectPrimitive.ItemText>
      <SelectPrimitive.ItemIndicator
        render={
          <span className="pointer-events-none absolute right-2 flex items-center justify-center flex-none" />
        }
      >
        <IconCheck className="pointer-events-none flex-none" />
      </SelectPrimitive.ItemIndicator>
    </SelectPrimitive.Item>
  );
}
