          ...
          >
            <div className="grid grid-cols-2 gap-2">
              <Field data-invalid={!!errors.fieldDefinitions?.[index]?.field}>
                <Input
                  placeholder={t("fieldDefinitionsEditor.fieldKeyPlaceholder")}
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              <Field data-invalid={!!errors.fieldDefinitions?.[index]?.path}>
                <Input
                  placeholder={t("fieldDefinitionsEditor.dataPathPlaceholder")}
            ...
            <Controller
              ...
              render={({ field: typeField }) =>
                typeField.value === "enum" || typeField.value === "set" ? (
                  <Input
                    placeholder={t("fieldDefinitionsEditor.optionsPlaceholder")}
