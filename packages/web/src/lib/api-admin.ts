...
export async function startSync(): Promise<{ success: boolean; data: SyncState }> {
  return apiPost<{ success: boolean; data: SyncState }>("/api/admin/sync");
}

export async function cancelSync(): Promise<{ success: boolean; data: SyncState }> {
  return apiDelete<{ success: boolean; data: SyncState }>("/api/admin/sync");
}

export async function getSyncStatus(): Promise<{ success: boolean; data: SyncState }> {
